...
(0, globals_1.describe)("ecs defines components correctly", () => {
    (0, globals_1.it)("should be able to retrieve correct debug info about component", () => {
        ...
        const ecs = new Ecs();
        {
            const { definition, bytesPerElement, name, id } = ecs.debugger.componentInfo(ecs.components.position);
            (0, globals_1.expect)(definition).toEqual({ x: "f64", y: "f64", z: "f64" });
            (0, globals_1.expect)(bytesPerElement).toBe(24);
            (0, globals_1.expect)(name).toBe("position");
            (0, globals_1.expect)(id).toBe(0);
        }
        {
            const { definition, bytesPerElement, name, id } = ecs.debugger.componentInfo(ecs.components.velocity);
            (0, globals_1.expect)(definition).toEqual({ x: "f64", y: "f64", z: "f64" });
            (0, globals_1.expect)(bytesPerElement).toBe(24);
        ...
        {
            const { definition, bytesPerElement, name, id } = ecs.debugger.componentInfo(ecs.components.npcs);
            (0, globals_1.expect)(definition).toEqual({ hair: "u16", health: "u16" });
    ...
    (0, globals_1.it)("should be able to retrieve all component debug info at once", () => {
        ...
        {
            const { definition, bytesPerElement, name, id } = debug[0];
            (0, globals_1.expect)(definition).toEqual({ x: "f64", y: "f64", z: "f64" });
            (0, globals_1.expect)(bytesPerElement).toBe(24);
            (0, globals_1.expect)(name).toBe("position");
            (0, globals_1.expect)(id).toBe(0);
        ...
        {
            const { definition, bytesPerElement, name, id } = debug[1];
            (0, globals_1.expect)(definition).toEqual({ x: "f64", y: "f64", z: "f64" });
            (0, globals_1.expect)(bytesPerElement).toBe(24);
            (0, globals_1.expect)(name).toBe("velocity");
            (0, globals_1.expect)(id).toBe(1);
        ...
        {
            const { definition, bytesPerElement, name, id } = debug[2];
            (0, globals_1.expect)(definition).toEqual({ hair: "u16", health: "u16" });
            (0, globals_1.expect)(bytesPerElement).toBe(4);
            (0, globals_1.expect)(name).toBe("npcs");
            (0, globals_1.expect)(id).toBe(2);
