...
(0, globals_1.describe)("component registry debug tools", () => {
    (0, globals_1.it)("debug tools returns correct metrics", () => {
        ...
        {
            const { definition, name, bytesPerElement, id } = (0, index_1.debugComponent)(registry.cat, components);
            (0, globals_1.expect)(definition).toEqual({ cuteness: "u8", angry: "u8" });
            (0, globals_1.expect)(id).toBe(0);
            (0, globals_1.expect)(name).toBe("cat");
            (0, globals_1.expect)(bytesPerElement).toBe(2);
        }
        {
            const { definition, name, bytesPerElement, id } = (0, index_1.debugComponent)(registry.bird, components);
            (0, globals_1.expect)(definition).toEqual({ maxFlightHeight: "i32", weight: "u16" });
