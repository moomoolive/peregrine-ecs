...
export declare type ComponentData<T extends ComponentDef> = {
    [key in keyof T]: ComponentType<T[key]>;
};
export declare type Component<T extends ComponentDef> = (ComponentData<T>);
export declare type RawComponent<T extends ComponentDef> = (ComponentData<T> & {
...
export interface ComponentClass<T extends ComponentDef> {
    ...
    readonly def: T;
    new (initialCapacity: number, allocator: Allocator): RawComponent<T>;
}
