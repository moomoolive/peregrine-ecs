...
exports.IGrid4DMixin = exports.IGrid3DMixin = exports.IGrid2DMixin = exports.IGrid1DMixin = void 0;
const mixin_js_1 = require("../mixin.js");
/**
 * Default implementation for {@link IGrid1D} methods.
 */
exports.IGrid1DMixin = (0, mixin_js_1.mixin)({
    order() {
        return [0];
    },
    includes(x) {
 ...
 */
exports.IGrid2DMixin = (0, mixin_js_1.mixin)({
    order() {
 ...
 */
exports.IGrid3DMixin = (0, mixin_js_1.mixin)({
    order() {
 ...
 */
exports.IGrid4DMixin = (0, mixin_js_1.mixin)({
    order() {
        return strideOrder(this.stride);
    },
    includes(x, y, z, w) {
